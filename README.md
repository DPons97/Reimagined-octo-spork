...
Every time a client connects to the server, the latter updates the planimetry of the system and communicates the node an "idle" operation that is, in our case study, a *Background subtraction* process. <br>
